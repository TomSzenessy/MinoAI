...
| `RELAY_PUBLIC_BASE_URL` | **Yes (recommended)** | none | `https://relay.mino.ink` |
...
| `MINO_RELAY_URL` | Yes | `https://relay.mino.ink` | `https://relay.mino.ink` |
...
|----------|----------|---------|
| `NEXT_PUBLIC_RELAY_URL` | **Yes** | `https://relay.mino.ink` |
